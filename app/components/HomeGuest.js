        ...
        <div className="col-lg-5 pl-lg-5 pb-3 py-lg-5">
          <form onSubmit={handleSubmit}>
            <div className="form-group">
              ...
              <input id="username-register" value={username} onChange={(e) => setUsername(e.target.value)}
            ...
            <div className="form-group">
              ...
              <input id="email-register" value={email} onChange={(e) => setEmail(e.target.value)}
               name="email" className="form-control" type="text" placeholder="you@example.com" autoComplete="off" />
            </div>
            <div className="form-group">
            ...
            <button type="submit" disabled={!password || !username || !email} className="py-3 mt-4 btn btn-lg btn-success btn-block">
