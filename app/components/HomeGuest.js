...
import { FLASH_MESSAGES, LOGIN} from "../actions/types";
    ...
    if (state.submitCount) {
      ...
      async function fetchResults() {
        try {
          ...
          appDispatch({ type: FLASH_MESSAGES, payload: "Congrats! Welcome to your new account." })
          console.log(response.data, 'test register')
        } catch (e) {
          console.log("There was a problem or the request was cancelled.")
        }
      }
